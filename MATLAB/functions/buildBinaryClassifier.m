function layers = buildBinaryClassifier(inputDim, latentDim, hiddenChannels, dropoutRate)
% buildBinaryClassifier  Build CNN layers for binary classifier
%
